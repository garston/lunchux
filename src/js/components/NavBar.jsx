            ...
            <div className="navTop">
                ...
                <div className="help">
                    ...
                    <Menu target="helpDropdown" align="right" valign="bottom"  ripple>
                        ...
                        <li><h3>Adult Income</h3>
                            <p>Enter gross income recieved. If you are self-employed please enter the net amount from work, which is calculated from subtracting total operating expenses from its revenue.
                            </p></li>
                    </Menu>
                </div>
            </div>
